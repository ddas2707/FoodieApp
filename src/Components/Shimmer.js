    ...
    return (
        <div className="restaurant-list">
            {Array(10).fill("").map((e, index) => <div key={index} className="shimmer-card">
                ...
                <div className="shimmer-desc stroke animate"></div>
                <div className="shimmer-add stroke animate"></div>
                <span className="card-end">
                    <div className="shimmer-rate stroke animate"></div>
                    <div className="shimmer-cft stroke animate"></div>
                </span>
            </div>)}
        </div>
    );
